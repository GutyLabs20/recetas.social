...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/css/plugin/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="{{url('/')}}/css/plugin/css/adminlte.min.css">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="categorias">
                    ...
                    <ul class="navbar-nav w-100 d-flex justify-content-between">
                        ...
                        <li class="nav-item manito-cursor">
    ...
    <script src="{{url('/')}}/js/plugin/adminlte.min.js"></script>
